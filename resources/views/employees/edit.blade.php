...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Update employee information for Sarah Johnson.</p>
        </div>
    ...
    <div class="form-card">
        <div class="form-header">
            <h3>Edit "Sarah Johnson"</h3>
            <p>Modify the employee information below.</p>
        </div>
        <div class="form-body">
            <form action="{{ route('employees.update', 1) }}" method="POST" data-validate>
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <select id="shift" name="shift" class="form-select">
                                    ...
                                    <option value="afternoon" selected>Afternoon (10AM - 6PM)</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="number" id="salary" name="salary" class="form-input" value="75000" min="0" step="1000">
                            </div>
                        </div>
                        <div class="form-group">
